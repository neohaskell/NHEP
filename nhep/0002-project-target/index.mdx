...
If a user doesn't fit the target audience doesn't mean that they shouldn't use NeoHaskell, it just means that the design process and showcasing process won't be prioritizing them.
...
Here we describe the target audience and user persona for the NeoHaskell project. All the design and development decisions will be made with this target audience and user persona in mind.
